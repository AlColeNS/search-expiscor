...
public class WhitespaceIOFactory extends PropertiesConfiguration.DefaultIOFactory
{
     ...
     */
    @Override
    public PropertiesConfiguration.PropertiesReader createPropertiesReader(Reader aReader, char aDelimiter)
    {
        return new WhitespacePropertiesReader(aReader, aDelimiter);
    }
}
