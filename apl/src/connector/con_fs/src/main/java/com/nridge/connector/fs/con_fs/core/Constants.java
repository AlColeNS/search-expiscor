...
public class Constants
{
    ...
    public static final int APPLICATION_PORT_NUMBER_DEFAULT = 8111;

    public static final String CFG_PROPERTY_PREFIX = "connector.fs";
    ...
    public static final String SCHEMA_FILE_NAME = "ds_fs_schema.xml";

    public static final String FS_DOCUMENT_TYPE = "FS Document";

    public static final String SOLR_REQUEST_HANDLER_DEFAULT = "select";

    public static final long QUEUE_POLL_TIMEOUT_DEFAULT = 60L;

    public static final String MAIL_SUBJECT_INFO = "NSD FS Connector Service Report";
    public static final String MAIL_DETAIL_MESSAGE = "Please refer to the 'con_fs.log' file for details.";
