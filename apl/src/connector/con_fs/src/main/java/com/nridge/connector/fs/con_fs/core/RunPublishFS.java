...
/**
 * The RunPublishFS is responsible for taking items off the
...
public class RunPublishFS implements Runnable
{
    private final AppMgr mAppMgr;
    private final CrawlQueue mCrawlQueue;

    public RunPublishFS(final AppMgr anAppMgr, CrawlQueue aCrawlQueue)
    {
        mAppMgr = anAppMgr;
