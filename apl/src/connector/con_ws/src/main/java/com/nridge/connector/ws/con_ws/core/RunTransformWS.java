...
/**
 * The RunTransformWS is responsible for taking items off the
...
public class RunTransformWS implements Runnable
{
    private final AppMgr mAppMgr;
    private final CrawlQueue mCrawlQueue;

    public RunTransformWS(final AppMgr anAppMgr, CrawlQueue aCrawlQueue)
    {
        mAppMgr = anAppMgr;
