...
import com.nridge.connector.ws.con_ws.restlet.RestletApplication;
...
public class TaskRestlet implements Task
{
        ...
        throws NSException
    {
        ...
        int portNumber = mAppMgr.getInt("restlet.port_number", Constants.APPLICATION_PORT_NUMBER_DEFAULT);
