...
/**
 * Implements the Hypersonic SQL RDBMS interfaces for index
 ...
 * @since 1.0
 */
public class HDBSQLIndex extends SQLIndex
{
     ...
     */
    public HDBSQLIndex(SQLConnection aConnection)
    {
        super(aConnection);
        ...
        throws NSException
    {
        ...
        if (aField.isFeatureAssigned(Field.FEATURE_INDEX_POLICY))
        {
            ...
            mSQLConnection.execute(String.format("CREATE INDEX %s ON %s(%s)",
